    ...
    async execute(client, interaction) {
        ...
        if (!data) {
            interaction.reply({
                ...
                const filter = i => i.customId === 'chespin' && i.user.id === interaction.user.id || i.customId === 'fennekin' && i.user.id === interaction.user.id || i.customId === 'froakie' && i.user.id === interaction.user.id;
                let pokename;
