  ...
  constructor() {
    super(
      new SlashCommandBuilder()
        ...
        .addUserOption((option) => option.setName("trainer").setDescription("The other trainer you want to know about!"))
  ...
  async execute(client, interaction) {
    ...
    if(!data) {
        ...
        const pokemonlist = data.pokemon.forEach((pokemon) => {
            nameList.push(pokemon.name.charAt(0).toUpperCase() + pokemon.name.slice(1));
            name = nameList.join("\n");
        })
